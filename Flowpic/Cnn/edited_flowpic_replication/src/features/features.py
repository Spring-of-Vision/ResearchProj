...
def pipeline(source, outdir):
    ...
    os.makedirs(os.path.join(outdir, 'GoogleDoc'), exist_ok=True)
    os.makedirs(os.path.join(outdir, 'GoogleDrive'), exist_ok=True)
    os.makedirs(os.path.join(outdir, 'Youtube'), exist_ok=True)
